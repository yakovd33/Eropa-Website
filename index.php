	...
	<body>
				...
				<div id="contact-modal">
					...
					<div id="contact-modal-left">
						<form class="contact100-form validate-form" id="modal-contact-form">
							...
							<div class="wrap-input100 rs1-wrap-input100 validate-input"> <span class="label-input100">*שם מלא</span> <input class="input100" id="modal-form-name" type="text" name="name" placeholder="הכנס את שמך המלא"> <span class="focus-input100"></span> </div>
							<div class="wrap-input100 rs1-wrap-input100 validate-input"> <span class="label-input100">*מספר טלפון/אימייל</span> <input class="input100" id="modal-form-contact" type="text" name="email" placeholder="הכנס את מספר הטלפון שלך או כתובת המייל שלך"> <span class="focus-input100"></span> </div>
							<div class="wrap-input100 validate-input" data-validate="Message is required" style="margin-bottom: 45px"> <span class="label-input100">הודעה (אופציונלי)</span> <textarea class="input100" id="modal-form-message" name="message" placeholder="לדוגמא: שלום, אני צריך אתר תדמית..."></textarea> <span class="focus-input100"></span> </div>
							<strong id="modal-form-feedback"></strong> 
							<div class="container-contact100-form-btn"> <button class="contact100-form-btn"> <span> שלח <i class="fas fa-arrow-left"></i> </span> </button> </div>
						</form>
					</div>
				</div>
			</div>
		...
		<div class="site-wrap">
			...
			<div id="packages-section">
					...
					<div class="row">
							...
							<div class="packaging-item" id="italy-package-item">
								...
								<div class="packaging-item-package-content">
									<div class="packaging-item-package-price">
										<span class="price-num" data-pricemonth="149" data-priceyear="1499" data-priceonce="999">149</span> 
										<super>₪</super>
									</div>
									<div class="packaging-item-package-type-of-payment">תשלום חודשי</div>
									<div class="sep"></div>
									<div class="packaging-item-desc">
										<div class="packaging-item-desc-item">עיצוב האתר וחווית משתמש <i class="fas fa-check-circle"></i></div>
										<div class="packaging-item-desc-item">קידום בסיסי בשיטת SEO <i class="fas fa-check-circle"></i></div>
										<div class="packaging-item-desc-item">אתר נקי וטעינת אתר מהירה <i class="fas fa-check-circle"></i></div>
										<div class="packaging-item-desc-item">הכנסת תמונות ותוכן <i class="fas fa-check-circle"></i></div>
										<div class="packaging-item-desc-item">טופס יצירת קשר/לידים מקושר <i class="fas fa-check-circle"></i></div>
									</div>
								</div>
						...
						<div class="col-md-4">
							<div class="packaging-item" id="germany-package-item">
								...
								<div class="packaging-item-package-content">
									<div class="packaging-item-package-price">
										<span class="price-num" data-pricemonth="249" data-priceyear="2400" data-priceonce="4000">249</span> 
										<super>₪</super>
									</div>
									<div class="packaging-item-package-type-of-payment">תשלום חודשי</div>
									<div class="sep"></div>
						...
						<div class="col-md-4">
							<div class="packaging-item" id="russia-package-item">
								...
								<div class="packaging-item-package-content">
									<div class="packaging-item-package-price">
										<span class="price-num" data-pricemonth="199" data-priceyear="1799" data-priceonce="2999">199</span> 
										<super>₪</super>
									</div>
									<div class="packaging-item-package-type-of-payment">תשלום חודשי</div>
									<div class="sep"></div>
				...
				<p id="packages-section-desc"><strong>המחירים המצוינים כאן אינם בהתחייבות ובהתאם לדרישתכם כך שייתכן שינוי בהצעת המחיר הסופית.</strong></p>
			</div>
			<div class="section" id="projects-section">
				...
				<img src="media/ver-dash.png" id="ver-dash" alt=""><!-- <div id="slider-tabs-selectors"> <div class="tab-selector" data-tab="websites-thumbs">אתרי אינטרנט</div><div class="tab-selector" data-tab="logos">לוגואים</div><div class="tab-selector" data-tab="bussinesses">עסקים שקידמנו</div></div>--> 
				<div id="jobs-slider">
					...
					<a href="https://night-light.co.il/" target="_blank">
						<div class="project-card">
							<div class="frame"> <img lsrc="media/websites/nightlight.jpg" style="object-fit: cover; height: 100%;" alt=""> </div>
			...
			<div id="blog-section">
				...
				<div class="blog-slider">
					<div class="blog-slider__wrp swiper-wrapper">
						<div class="blog-slider__item swiper-slide" onclick="location.href='https\://eropa.co.il/blog/%d7%9e%d7%94%d7%99-%d7%94%d7%97%d7%a9%d7%99%d7%91%d7%95%d7%aa-%d7%a9%d7%9c-%d7%a7%d7%99%d7%93%d7%95%d7%9d-%d7%94%d7%a2%d7%a1%d7%a7-%d7%91%d7%90%d7%99%d7%a0%d7%98%d7%a8%d7%a0%d7%98/'">
							...
							<div class="blog-slider__content">
								...
								<div class="blog-slider__text">בד בבד עם התרחבותה של הרשת הפך #קידום_אתרים_באינטרנט לכלי חיוני ונדרש. למעשה, כל עסק המעוניין להפיק תועלת אמיתית מהאתר שלו חייב לבצע קידום באינטרנט בדרכים מסוימות, אחרת פשוט יישאר האתר ללא פעילות משמעותית ויהווה כרטיס ביקור בלבד.</div>
								<a href="#" class="blog-slider__button">קראו עוד</a> 
							</div>
						</div>
						<div class="blog-slider__item swiper-slide" onclick="location.href='https\://eropa.co.il/blog/%d7%9e%d7%93%d7%95%d7%a2-%d7%9b%d7%9c-%d7%a2%d7%a1%d7%a7-%d7%a6%d7%a8%d7%99%d7%9a-%d7%90%d7%aa%d7%a8/'">
							<div class="blog-slider__img"> <img src="media/posts/4-s.jpg" alt=""> </div>
							<div class="blog-slider__content">
								<span class="blog-slider__code">16 בינואר 2021</span> 
								<div class="blog-slider__title">מדוע כל עסק צריך אתר?</div>
								<div class="blog-slider__text">בעלים של עסק קטן? או אפילו עסק גדול? אולי אתם עדיין לא יודעים את זה אפילו, אבל כנראה שגם אתם צריכים אתר לעסק שלכם. אתר אינטרנט זה מה שמגדיר את המותג הפרט שלכם.</div>
								<a href="#" class="blog-slider__button">קראו עוד</a> 
							</div>
						</div>
						<div class="blog-slider__item swiper-slide" onclick="location.href='https\://eropa.co.il/blog/%d7%90%d7%99%d7%9a-%d7%94%d7%a7%d7%99%d7%a9%d7%95%d7%a8%d7%99%d7%9d-%d7%91%d7%90%d7%aa%d7%a8-%d7%a9%d7%9c%d7%9b%d7%9d-%d7%9e%d7%a9%d7%a4%d7%99%d7%a2%d7%99%d7%9d-%d7%a2%d7%9c-%d7%94%d7%a7%d7%99%d7%93/'">
							...
							<div class="blog-slider__content">
								...
								<div class="blog-slider__text">קידום אתרים במנועי חיפוש הינו מגוון פעולות אשר מתבצעות במטרה לשפר את מיקומי דפיו של אתר אינטרנט בתוצאות החיפוש, עד להשגת מיקומים בצמרת תוצאות החיפוש שיניבו תוצאות אשר מצדיקות את ההשקעה בקידום האתר.</div>
								<a href="#" class="blog-slider__button">קראו עוד</a> 
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-sm-12">
								<a href="#" class="home-services-item">
									...
									<p>פיתוח node.js, הפלטפורמה שכבשה את השוק וכרגע מובילה מהפיכה בתחום וכבר נחשבת סטנדרט בפיתוח ווב.</p>
								</a>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12">
								<a href="#" class="home-services-item">
									...
									<p>אצלנו יש את הדגש הגבוה ביותר על העיצוב, כי זה מה שמושך את העין של הלקוח קודם. המעצבים שלנו ידאגו לכם לאתר יפהפה.</p>
								</a>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12">
								<a href="#" class="home-services-item">
									...
									<p>שימוש במערכת בקוד פתוח על מנת ליצור עמודי נחיתה, אתרי תדמית, מערכות ואתרי חנות בוורדפרס.</p>
								</a>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12">
								<a href="#" class="home-services-item">
									...
									<p>פיתוח ממשקים רספונסיביים בסטנדרט הגבוה ביותר. ממשקים מתקדמים ונעימים לעין שעוצבו על ידי צוות העיצוב שלנו.</p>
								</a>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12">
								<a href="#" class="home-services-item">
									...
									<p>אצלנו יודעים איך לקדם את האתר שלכם בגוגל למקום הראשון. המומחים שלנו יזניקו אתכם ואת האתר שלכם בגוגל וברשתות חברתיות.</p>
								</a>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12">
								<a href="#" class="home-services-item">
									...
									<p>אצלנו תוכלו לקבל את האתרים שאתם רוצים עם הפיצ'רים שאתם רוצים. נעבור ביחד איתכם משלב התכנון והאיפיון לשלב העיצוב והפיתוח.</p>
								</a>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-4 col-sm-12">
						...
						<div class="address" dir="rtl">
							...
							<ul class="social">
								...
								<li><a href="https://www.instagram.com/eropa_digital/"><i class="fab fa-instagram"></i></a></li>
								<li><a href="https://api.whatsapp.com/send?phone=972586194321&amp;text=Test" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
					...
					<div class="col-lg-5 col-md-12 col-sm-12">
						<div class="logo"> <span><strong><i class="fa fa-globe"></i> אירופה</strong></span> <span>בניית אתרים</span> </div>
						<div class="text"> אירופה בניית אתרים נוסדה בשנת 2017 על מנת לתת מענה דיגיטלי לאנשים פרטיים ובתי עסק אשר רוצים להתרחב במרחב הדיגיטלי ולפתח את העסק שלהם באינטרנט על מנת למשוך יותר לקוחות ופניות. </div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
